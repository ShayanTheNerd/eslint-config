...
function getZodRules(options: DeepNonNullable<Options>) {
  ...
  const miniRules = {
    ...
    'zod-mini/no-conflicting-checks': 'warn',
    ...
    'zod-mini/no-unnecessary-readonly': 'warn',
    'zod-mini/prefer-enum-over-literal-union': 'warn',
    'zod-mini/prefer-map-set-size-over-min-max': 'warn',
